...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1066292207ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=task_manager&table=task">`task_manager`.`task`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mini_smp&table=user">`mini_smp`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mini_smp&table=student_info">`mini_smp`.`student_info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=enamdev_onlinedelivery&table=users">`enamdev_onlinedelivery`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=enamdev_onlinedelivery&table=marchant_info">`enamdev_onlinedelivery`.`marchant_info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=enamdev_onlinedelivery&table=marchant_order">`enamdev_onlinedelivery`.`marchant_order`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=enamdev_onlinedelivery&table=marchant_payment">`enamdev_onlinedelivery`.`marchant_payment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=manegment&table=employee_info">`manegment`.`employee_info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=manegment&table=emp_salary">`manegment`.`emp_salary`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=manegment&table=employee">`manegment`.`employee`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="48383d4c4b42766675302a394a6d6b74">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="task_manager" targettable="task">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `task_manager`.`task` ( `id` INT NOT NULL AUTO_INCREMENT ,  `task` VARCHAR(100) NOT NULL ,  `date` DATE NOT NULL ,  `status` INT NOT NULL DEFAULT &#039;0&#039; ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">UPDATE `task` SET `status`= 1 WHERE `id`=&#039;1&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="task_manager" targettable="task">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">UPDATE `task` SET `status`= 1 WHERE `id`=&#039;2&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="task_manager" targettable="task">
                            <div class="action_content">
